        ...
        implements Split
{
    ...
    {
        if (partitionId.equals(MySQLPartition.UNPARTITIONED_ID)) {
    ...
    public MySQLTableHandle getMySQLTableHandle()
    {
        return new MySQLTableHandle(connectorId, schema, table);
    }
}
