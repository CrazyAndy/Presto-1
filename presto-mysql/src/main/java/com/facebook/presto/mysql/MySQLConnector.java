        ...
        implements Connector
{
    ...
    private final MySQLHandleResolver handleResolver;

    @Inject
    public MySQLConnector(
            MySQLMetadata metadata,
            MySQLSplitManager splitManager,
            MySQLRecordSetProvider recordSetProvider,
            MySQLHandleResolver handleResolver)
    {
