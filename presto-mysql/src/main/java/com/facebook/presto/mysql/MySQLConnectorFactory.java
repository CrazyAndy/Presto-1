        ...
        implements ConnectorFactory
{
    ...
    public MySQLConnectorFactory(String name, Map<String, String> optionalConfig)
    {
    ...
    public Connector create(String connectorId, Map<String, String> config)
    {
        ...
        try {
            Bootstrap app = new Bootstrap(
                    ...
                    new MBeanModule(),
                    new JsonModule(),
                    new MySQLClientModule(connectorId),
                    new Module()
                    {
                        @Override
            ...
            return injector.getInstance(MySQLConnector.class);
        }
        catch (Exception e) {
