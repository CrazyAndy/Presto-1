...
public class TestMySQLClientConfig
{
    @Test
    public void testDefaults()
    {
        ConfigAssertions.assertRecordedDefaults(ConfigAssertions.recordDefaults(MySQLClientConfig.class)
    ...
    public void testExplicitPropertyMappings()
    {
        ...
        MySQLClientConfig expected = new MySQLClientConfig()
