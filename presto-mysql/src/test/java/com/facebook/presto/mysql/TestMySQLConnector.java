...
public class TestMySQLConnector
{
            ...
            throws Exception
    {
        ...
        MySQLConnectorFactory connectorFactory = new MySQLConnectorFactory(
                connectorId,
        ...
        assertInstanceOf(metadata, MySQLMetadata.class);

        splitManager = connector.getSplitManager();
        assertInstanceOf(splitManager, MySQLSplitManager.class);

        recordSetProvider = connector.getRecordSetProvider();
        assertInstanceOf(recordSetProvider, MySQLRecordSetProvider.class);

        ConnectorHandleResolver handleResolver = connector.getHandleResolver();
        assertInstanceOf(handleResolver, MySQLHandleResolver.class);
            ...
            throws Exception
    {
        ...
        for (Split split : splits) {
            MySQLSplit cassandraSplit = (MySQLSplit) split;
    ...
    private static ImmutableMap<String, Integer> indexColumns(List<ColumnHandle> columnHandles)
    {
        ...
        for (ColumnHandle columnHandle : columnHandles) {
            checkArgument(columnHandle instanceof MySQLColumnHandle, "columnHandle is not an instance of CassandraColumnHandle");
            MySQLColumnHandle hiveColumnHandle = (MySQLColumnHandle) columnHandle;
